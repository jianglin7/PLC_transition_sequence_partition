...
# net, im, fm = pm4py.read_pnml('D:/小七/app/py/code/Sequence_partition/Experiment/0594.pnml')
net, im, fm = pm4py.read_pnml('0041.pnml')
...
# pm4py.write_xes(log, "D:/小七/app/py/code/Sequence_partition/Experiment/0594.xes")
pm4py.write_xes(log, "0041.xes")
...
# tree = ET.parse('D:/小七/app/py/code/Sequence_partition/Experiment/0594.xes')
